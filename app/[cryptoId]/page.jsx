...
// const CryptoDetailView = ({ cryptoId }) => {
...
//       const response = await fetch(
//         `https://api.coingecko.com/api/v3/coins/bitcoin/market_chart?vs_currency=${currency}&days=${timeframe.days}`
//       );
...
//             <p className="text-red-500 text-center">{"Rate limits for coin gecko website"}</p>
//             <Button
...
//             <p className="text-gray-600">{cryptoData.symbol.toUpperCase()}</p>
//           </div>
//         </div>
//         <Button>
//           Add to Watchlist
...
//                   {formatPrice(cryptoData.market_data.current_price[currency])}{currency?.toUpperCase()}
//                 </h2>
//               </div>
...
//           </Typography>
//           <div className="flex items-center justify-between">
//             <div className="flex dark:text-white gap-2 mt-2 flex-wrap">
//               {timeframes.map((timeframe) => (
//                 <Button
//                   key={timeframe.value}
//                   variant={"outline"}
//                   style={{
//                    background: selectedTimeframe === timeframe.value ? "rgba(0,0,0,0)" : "rgba(0,0,0,1)",
//                    color: selectedTimeframe === timeframe.value ? "black" : "white",
//                   }}
...
//         <Card>
//           <CardHeader>
//             <Typography>Market Stats</Typography>
//           </CardHeader>
//           <CardContent>
